...
import core.RSA;
import attacks.FermatMathAttack;

import javax.imageio.ImageIO;


public class FermatMathAttackGraph extends Application {
    private final static int NUM_RUNS = 1000;
    private final static int NANO_TO_MICRO = (int) Math.pow(10, 3);

    @Override
    public void start(Stage stage) {
        stage.setTitle("Fermat Math Attack");
        ...
        lineChart.setTitle("Fermat Math Attack");
        XYChart.Series series = new XYChart.Series();
        series.setName("Fermat Math Attack");
        ...
        for (int size = 32; size <= 80; ++size) {
            ...
            new FermatMathAttack(rsa.publicKey, rsa.modulus);
        ...
        File file = new File("Fermat MathAttack.png");
        try {
